...
class bucketlist1 extends StatefulWidget {
  ...
  @override
  State<bucketlist1> createState() => _bucketlist1State();
}

class _bucketlist1State extends State<bucketlist1> {
  List<Item> Sapa = [];
  List<Item> Drinks = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Bucket Sapa'),
          actions: <Widget>[
            InkWell(
              onTap: () {
                if (context
                    .read<sellectbucket>()
                    .checkempty(widget.pageid, 0)) {
                  ...
                  context.read<sellectbucket>().savelistfinal(0, widget.pageid);
                }
              },
              child: Center(
                child: Container(
  ...
  Widget questionbox(BuildContext context) {
    return Consumer<fetchprovider>(builder: (context, value, child) {
      if (value.loading == true) {
        ...
        Sapa = value.Sapa;
        ID.clear();
        for (var i = 0; i < Sapa.length; i++) {
          ID.add(Sapa[i].itemId);
        }
        Function unOrdDeepEq = const DeepCollectionEquality.unordered().equals;
        context.read<sellectbucket>().getbucket(ID, Sapa, 0);
        return Container(
              ...
              children: [
                          ...
                          children: [
                            ...
                            widget.pageid == 0
                                ? Checkbox(
                                    ...
                                    value: unOrdDeepEq(
                                        context.watch<sellectbucket>().allID,
                                        context
                                            .watch<sellectbucket>()
                                            .sellectID),
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    List<Extra>? packageinclude = Sapa[index].extras;
                    String? image = Sapa[index].image;
                    return InkWell(
                      onTap: () {
