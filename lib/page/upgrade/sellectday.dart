...
class sellectday extends StatefulWidget {
  ...
  @override
  State<sellectday> createState() => _sellectdayState();
}

class _sellectdayState extends State<sellectday> {
        ...
        children: [
          ...
          Container(
            ...
            child: ElevatedButton(
                ...
                onPressed: () async {
                  print(Provider.of<subscribed>(context, listen: false)
                      .frequency);
                  print(sellectfrequency[0]);
                  if (sellectfood.isEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                      content: CustomeSnackbar(
                        topic: 'Oh Snap!',
                        msg:
                            "You can't sellect a frequenct lower than the existing one",
                        color1: Color.fromARGB(255, 171, 51, 42),
                        color2: Color.fromARGB(255, 127, 39, 33),
                      ),
                      behavior: SnackBarBehavior.floating,
